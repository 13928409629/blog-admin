    ...
    <a-card class="content-card">
      ...
      >
        ...
        <template slot="type" slot-scope="t">
          ...
          <a-tag v-else color="red">行内资讯</a-tag>
        </template>
...
import { getArticleList,deleteArticle } from '@/api/manage'
  ...
  data () {
    return {
      ...
      columns: [
        ...
        // {title: '文章标签',dataIndex: 'type',key: 'type',scopedSlots: {customRender: 'type'},align:'center'},
    ...
    handleEditorClick(r) {
      ...
      if(r.img) {
        this.$refs.CreateModal.fileList.push({
          ...
          url: process.env.VUE_APP_API_ORIGIN+r.img
        })
      }
    },
    // 删除
